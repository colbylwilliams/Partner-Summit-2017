...
namespace XWeather.iOS
{
	public partial class WeatherPvc : UIPageViewController
	{
		...
		public override void PrepareForSegue (UIStoryboardSegue segue, NSObject sender)
		{
			...
			if (segue.Identifier?.Equals ("locationsSegue", StringComparison.OrdinalIgnoreCase) ?? false)
			{
		...
		partial void weatherBotButtonClicked (NSObject sender)
		{
			var botController = Storyboard.Instantiate<WeatherBotVc> ();

			NavigationController.PresentViewController (botController, true, null);
		}


		partial void bottomBarLongPressed (NSObject sender)
		{
