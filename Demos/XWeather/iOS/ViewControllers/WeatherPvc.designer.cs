...
namespace XWeather.iOS
{
	...
	partial class WeatherPvc
	{
		...
		[Action ("bottomBarLongPressed:")]
		partial void bottomBarLongPressed (Foundation.NSObject sender);
		...
		[Action ("weatherBotButtonClicked:")]
		partial void weatherBotButtonClicked (Foundation.NSObject sender);
